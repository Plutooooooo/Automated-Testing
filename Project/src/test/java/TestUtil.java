...
public class TestUtil {
    ...
    public void NextDayTest() throws IOException {
        Set<String> classLevelRes = readFile("selection-class-NextDay.txt");
        Set<String> methodLevelRes = readFile("selection-method-NextDay.txt");
        Set<String> classLevelData = readFile( "E:\\SE\\AutomatedTesting\\walarepo\\wala\\Data\\4-NextDay\\data\\selection-class.txt");
        Set<String> methodLevelData = readFile("E:\\SE\\AutomatedTesting\\walarepo\\wala\\Data\\4-NextDay\\data\\selection-method.txt");
        assertTrue(cmpRes(classLevelRes, classLevelData));
        assertTrue(cmpRes(methodLevelRes, methodLevelData));
    }
